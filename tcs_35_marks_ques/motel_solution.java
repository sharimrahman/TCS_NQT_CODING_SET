...
public class motel_solution
{
    public static void main(String[] args)
    {
        ...
        int sum=totalNoOfRoomsBooked(arr,cabFacility);
        if(sum!=0)
        {
    ...
    public static int totalNoOfRoomsBooked(Motel[] arr, String cabFacility)
    {
        ...
        {
            if(arr[i].getCabFacility().equalsIgnoreCase(cabFacility) && arr[i].getNoOfRoomsBooked()>5)
            {
